...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b>DU<span>K</span></b></a>
      <!--logo end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.html"><img src="../project/images/2.jpg" class="img-circle" width="80"></a></p>
          <h5 class="centered">Dua Imam</h5>
          <li class="mt">
    ...
    <footer class="site-footer">
      <div class="text-center">
        <p>
          &copy; Duaimam <strong>@</strong>gmail.com
        </p>
        <div class="credits">
          <!--
