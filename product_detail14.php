				...
				<ul class="header-cart-wrapitem w-full">
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="images/product-15.jpg" alt="IMG">
						</div>
					...
					<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								...
								<a href="product_detail14.php" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1">
									Quick View
								</a>
							</div>
							...
							<div class="block2-txt flex-w flex-t p-t-14">
								<div class="block2-txt-child1 flex-col-l ">
									<a href="product_detail14.php" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
										Esprit Ruffle Shirt
									</a>
